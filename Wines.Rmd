...
meanVarstall <- meanVars %>%
  gather(variable,avgMeasurement,fixed.acidity:alcohol) %>%
  select(-Id)
...
logomodel <- polr(quality ~  volatile.acidity + chlorides + total.sulfur.dioxide + sulphates + alcohol + pH + sulphates + total.sulfur.dioxide , Hess = T, data = df,) 
summary(logomodel)
